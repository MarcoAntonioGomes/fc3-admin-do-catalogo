...
public class CategoryTest {
    ...
    @Test
    public void givenAValidCategory_whenCallUpdate_thenReturnAnCategoryUpdated() {

        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;

        final var aCategory = Category.newCategory("fILM", "a CATE", expectedIsActive);
    ...
    public void givenAValidCategory_whenCallUpdateToInactive_thenReturnAnCategoryUpdated() throws InterruptedException {
        ...
        final var aCategory = Category.newCategory("fILM", "a CATE", true);
