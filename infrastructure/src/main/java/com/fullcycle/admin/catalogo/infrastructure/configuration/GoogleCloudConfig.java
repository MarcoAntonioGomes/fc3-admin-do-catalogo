...
public class GoogleCloudConfig {
    ...
    public Credentials credentials(final GoogleCloudProperties properties) {
        ...
        try {
            final var bais = new ByteArrayInputStream(jsonContent);
            return GoogleCredentials.fromStream(bais);
        } catch (IOException e) {
            throw new RuntimeException("Error to create credentials", e);
        }
    ...
    public Storage storage(
        ...
        final var transporOptions= HttpTransportOptions.newBuilder()
        ...
        final var options = StorageOptions.newBuilder()
                ...
                .setTransportOptions(transporOptions)
