...
public class GetGenreByIdUseCaseIT {
   ...
   @Autowired
    ...
    public void givenAValidId_whenCallsGetGenre_shouldReturnGenre() {
        ...
        final var filmes =  categoryGateway.create(Category.newCategory("Filmes", "Filmes de ação", true));
        final var series = categoryGateway.create(Category.newCategory("Séries", "Séries de ação", true));
       ...
       // when
        ...
        Assertions.assertTrue(expectedCategories.size() ==  actualGenre.categories().size() && asString(expectedCategories).containsAll(actualGenre.categories()));
