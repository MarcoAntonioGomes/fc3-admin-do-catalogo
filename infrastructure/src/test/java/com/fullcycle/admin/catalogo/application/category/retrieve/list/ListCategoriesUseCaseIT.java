...
public class ListCategoriesUseCaseIT {
    ...
    void mockUp() throws InterruptedException {
        ...
        var category = Category.newCategory("Filmes", null, true);
        categories.add(category);
        Thread.sleep(100);
        category = Category.newCategory("Netflix Originals", "Títulos de autoria da Netflix", true);
        categories.add(category);
        Thread.sleep(100);
        category = Category.newCategory("Amazon Originals", "Títulos de autoria da Amazon Prime", true);
        categories.add(category);
        Thread.sleep(100);
        category = Category.newCategory("Documentários", null, true);
        categories.add(category);
        Thread.sleep(100);
        category = Category.newCategory("Sports", null, true);
        categories.add(category);
        Thread.sleep(100);
        category = Category.newCategory("Kids", "Categoria para crianças", true);
        categories.add(category);
        Thread.sleep(100);
        category = Category.newCategory("Series", null, true);
        categories.add(category);
