...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAValidCategory_whenCallsCreate_shouldReturnANewCategory() {
        ...
        final var expectedDescription = "Filmes de todos os tipos";
    ...
    public void givenAValidCategory_whenCallsUpdate_shouldReturnACategoryUpdated() {
        ...
        final var aCategory = Category.newCategory("Fil e", null, expectedIsActive);
        ...
        Assertions.assertEquals("Fil e", actualInvalidEntity.getName());
